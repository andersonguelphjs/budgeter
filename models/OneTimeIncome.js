export const OneTimeIncomeSchema = [
...
export default class OneTimeIncome {
    constructor(config) {
    ...
    static fromJSON(jsonData) {
      ...
      return new OneTimeIncome(data.id, data.type, data.color, data.description, date.amount, data.translation_key);
    }
  }
